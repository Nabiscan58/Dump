-- CONFIG PNJ DE REMPLACEMENT POUR CHAQUE COMMERCE
-- Règle : si aucun joueur AVEC CE JOB n'est présent physiquement dans la zone,
-- alors on affiche le PNJ vendeur. Ce PNJ vend aussi les items listés ici.
...
ShopNPCConfig = {
    {
        ...
        checkCenter = vector3(238.35929870605, -901.98736572266, 29.623210906982),
        checkRadius = 10.0,

        pedModel = "mp_m_shopkeep_01",
        pedCoords = vector4(240.16511535645, -897.31988525391, 28.623229980469, 143.57727050781),
