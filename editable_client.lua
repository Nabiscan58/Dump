...
Citizen.CreateThread(function()
    AddTextEntry('TEN_SE_HINT', Config.Translation.SERVE_HINT or 'To correctly serve, aim with key ~y~~a~~s~ to hit ~y~highlighted~s~ rectangle.~n~Ball must ~y~hit ground~s~ first before opponent can return.~n~~y~LEFT CLICK~s~ to initiate serve.')
end)
