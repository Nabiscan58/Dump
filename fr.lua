Locales['fr'] = {
  ...
  ['fine'] = 'Amende',
  ['unpaid_bills'] = 'Gérer les factures impéyées',
  ...
  ['being_searched'] = 'La ~b~Fourriere~s~ te fouille',
  -- Vehicle interaction
  ['vehicle_info'] = 'infos véhicule',
  ['pick_lock'] = 'crocheter véhicule',
  ['vehicle_unlocked'] = 'véhicule ~y~déverouillé~s~',
 ...
 ['prison'] = 'Prison fédéral',
  ...
  ['you_confiscated_account'] = 'tu as confisqué~y~€%s~s~ (%s) par ~b~%s~s~',
  ['got_confiscated_account'] = '~y~€%s~s~ (%s) was confiscated by ~y~%s~s~',
  ['you_confiscated_weapon'] = 'Tu as confisqué~b~%s~s~ par ~b~%s~s~ avec ~o~%s~s~ bullets',
  ...
  ['fourriere_stock'] = 'fourriere Stock',
  -- Misc
  ['remove_prop'] = 'appuyez sur ~INPUT_CONTEXT~ pour enlever l\'objet',
  ['map_blip'] = 'Poste de Fourriere',
  ['map_blip1'] = 'Commissariat Fourriere',
  ['unrestrained_timer'] = 'Vous sentez que vos menottes perdent lentement leur emprise et disparaissent.',
  -- Notifications
  ['alert_fourriere'] = 'alerte fourriere',
  ['phone_fourriere'] = 'fourriere',
}
