...
AddEventHandler("SlashTires:SlashClientTire", function(tireIndex)
    local allowedWeapons = {"WEAPON_KNIFE", "WEAPON_BOTTLE", "WEAPON_DAGGER", "WEAPON_HATCHET", "WEAPON_MACHETE", "WEAPON_SWITCHBLADE", "WEAPON_SCREWDRIVER", "WEAPON_KITCHENKNIFE"}
    ...
    if isAllowedWeapon then
        ...
        ESX.ShowNotification("Vous devez avoir un objet tranchant en main pour crever un pneu !")
    end
end)
