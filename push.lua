...
--         if Distance < 9.0  and not IsPedInAnyVehicle(ped, false) then
--             onpush = true
...
--                 --ESX.Game.Utils.DrawText3D({x = Vehicle.Coords.x, y = Vehicle.Coords.y, z = Vehicle.Coords.z}, 'Press [~y~SHIFT~w~] and [~y~Z~w~] to push the vehicle', 0.4)
--             --end
