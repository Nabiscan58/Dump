...
api.addGlobalVehicle({
    {
        ...
        label = "Ouvrir Porte avant droite",
    ...
    },
    {
        ...
        icon = 'fa-solid fa-car-side',
        label = "Ouvrir Porte avant gauche",
    ...
    },
    {
        ...
        icon = 'fa-solid fa-car-side',
        label = "Ouvrir Porte arrière gauche",
    ...
    },
    {
        ...
        icon = 'fa-solid fa-car-side',
        label = "Ouvrir Porte arrière droite",
    ...
    {
        name = 'ox_target:crevePneu1',
        icon = 'fa-regular fa-circle-dot',
        label = "Crever le pneu",
        bones = { 'wheel_lf' },
        distance = 2,
        onSelect = function(data)
            TriggerEvent("SlashTires:SlashClientTire", "wheel_lf")
        end
    },
    {
        name = 'ox_target:crevePneu2',
        icon = 'fa-regular fa-circle-dot',
        label = "Crever le pneu",
        bones = { 'wheel_lr' },
        distance = 2,
        onSelect = function(data)
            TriggerEvent("SlashTires:SlashClientTire", "wheel_lr")
        end
    },
    {
        name = 'ox_target:crevePneu3',
        icon = 'fa-regular fa-circle-dot',
        label = "Crever le pneu",
        bones = { 'wheel_rf' },
        distance = 2,
        onSelect = function(data)
            TriggerEvent("SlashTires:SlashClientTire", "wheel_rf")
        end
    },
    {
        name = 'ox_target:crevePneu4',
        icon = 'fa-regular fa-circle-dot',
        label = "Crever le pneu",
        bones = { 'wheel_rr' },
        distance = 2,
        onSelect = function(data)
            TriggerEvent("SlashTires:SlashClientTire", "wheel_rr")
        end
    },
    {
        name = 'ox_target:hideInTrunk',
        icon = 'fa-solid fa-car-rear',
        label = "Se cacher",
        offset = vec3(0.5, 0, 0.5),
        distance = 2,
        ...
        onSelect = function(data)
            TriggerEvent("server_utils:hideInCar")
        end
    }
})