...
Citizen.CreateThread(function()
	while true do
        local inPolMav = false
			if IsVehicleModel(GetVehiclePedIsIn(PlayerPedId()), GetHashKey("polmav")) == 1 or IsVehicleModel(GetVehiclePedIsIn(PlayerPedId()), GetHashKey("jcon")) == 1 or IsVehicleModel(GetVehiclePedIsIn(PlayerPedId()), GetHashKey("spvhjv")) == 1 then
				inPolMav = true
