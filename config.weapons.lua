Config.Weapons = {
	...
	
	{
		...
		label = _U('weapon_specialcarabine_mk2'),
		components = {}
	},
	
	{
		name = 'WEAPON_BULLPUPRIFLE_MK2',
		label = _U('weapon_bullpruprifle_mk2'),
		components = {}
	},
	...
	
	{
		...
		label = _U('weapon_pepperspray'),
		components = {}
	},

	{
		name = 'WEAPON_CHAINSAW',
		label = _U('weapon_chainsaw'),
		components = {}
	},

	{
		name = 'WEAPON_SLICE',
		label = _U('weapon_slice'),
		components = {}
	},

	{
		name = 'WEAPON_DEMHAMMER',
		label = _U('weapon_demhammer'),
		components = {}
	},
	...
	{
		name = 'WEAPON_FRYINPAN',
		label = _U('WEAPON_FRYINPAN'),
		components = {}
	},

	{
		name = 'WEAPON_ASSAULTRIFLELS',
		label = _U('WEAPON_ASSAULTRIFLELS'),
		components = {}
	},

	{
		name = 'WEAPON_PATRIOTKNIFE',
		label = _U('WEAPON_PATRIOTKNIFE'),
		components = {}
	},

	{
		name = 'WEAPON_CARROTSWORD',
		label = _U('weapon_carrotsword'),
		components = {}
	},
...

	{
		...
		label = _U('weapon_tacticalrifle'),
		components = {}
	},

	{
		name = 'WEAPON_CANDYCANE',
		label = _U('weapon_candycane'),
		components = {}
	},

	{
		name = 'WEAPON_CANDYKNIFE',
		label = _U('weapon_candyknife'),
		components = {}
	}
