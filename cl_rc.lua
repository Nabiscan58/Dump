...
RegisterNetEvent('RcCar:LessGo')
AddEventHandler('RcCar:LessGo', function()
	RCCar.Start()
end)
...
RCCar.Start = function()
	...
	while DoesEntityExist(RCCar.Entity) do --and DoesEntityExist(RCCar.Driver) do
		Citizen.Wait(5)
...
RCCar.Spawn = function()
	...
	SetVehicleNumberPlateText(RCCar.Entity, "RCBAN")
	SetVehicleDoorsLocked(RCCar.Entity, 2)
...
RCCar.ToggleCamera = function(boolean)
	if boolean then
		...
		AttachCamToEntity(RCCar.Camera, RCCar.Entity, 0.0, -3.0, 1.1, true)
